...
public class AdminDashboard extends Stage{
    ...
    public AdminDashboard() throws IOException {
        ...
        FXMLLoader addNewAccount2 = new FXMLLoader(getClass().getResource("AdminFXML/addNewAccount.fxml"));
        Parent addNewAccountRoot = addNewAccount2.load();     
        addNewAccount = new Scene(addNewAccountRoot);
    ...
    public void changeSceneToAddNewAccount(){
        this.setScene(accountsManagmentScene);
    }
